    ...
    <div class="table" v-loading="$root.showLoadingIcon">
        <div class="crumbs">
            <el-breadcrumb separator="/">
				<!-- TODO 修改下图标-->
                <el-breadcrumb-item><i class="el-icon-lx-cascades"></i> 意见与反馈列表</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            ...
            <el-table :data="data" border class="table">
               ...
               <el-table-column prop="name" label="反馈者" align="center"></el-table-column>
    ...
    export default {
        ...
        data() {
            return {
				...
				listUrl : 'my/listFeedBack',
				addUrl : 'food/addFood',
				editUrl : 'food/updateFood',
				delUrl : 'my/deleteFeedBack',
        ...
        computed: {
            ...
            data() {
				var vue = this;
                return vue.cabinets.map((feedBack,index) => {
                   return {
					   index : index + 1,
					   id : feedBack.id,
					   name:feedBack.customer.nickname,
        ...
        methods: {
            ...
            deleteRow(){
				var vue = this;				
				//使用axios删除
				var url = vue.delUrl + "?feedBackId=" + vue.waitToDel.id;
				vue.$jsonAxios.get(url).then(function(response){
